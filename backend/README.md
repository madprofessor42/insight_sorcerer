...
**Важно:** История сообщений является **сессионной** и существует только в рамках одного WebSocket соединения.

- ✅ История **сохраняется** во время активной сессии (пока окно чата открыто)
- ❌ История **очищается** при закрытии чата или размонтировании компонента
- 🆕 Каждое новое открытие чата = новая чистая сессия

Это обеспечивает:
- 🔒 **Приватность** - история не хранится после закрытия
- 🎯 **Свежий контекст** - каждый новый разговор начинается "с чистого листа"
- 💾 **Минимальное использование памяти** - история не накапливается
